/**
 * MediaAggregator
 * A class designed to wrangle multiple MediaService objects together.
 */
...
MediaAggregator.prototype.serviceInitialized = function(service) {
  ...
  // When one service finishes initializing, it calls to this function.  We need to wait
  // until all services are finished initializing before we tell them to start streaming,
  // though.
