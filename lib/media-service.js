/**
 * MediaService
 * "Abstract" class to provide some framework for media service objects.  This allows us
 * to treat all social media services through a standard interface, which makes it easier
 * to mix and match multiple services together.
 */
